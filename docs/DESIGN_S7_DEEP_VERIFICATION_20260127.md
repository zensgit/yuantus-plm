# S7 Deep Verification Design (2026-01-27)
...
- Platform admin enabled for provisioning
...
bash scripts/run_s7_deep.sh http://127.0.0.1:7910 tenant-1 org-1 tenant-2 org-2 \
  | tee docs/VERIFICATION_S7_DEEP_20260127_4.md
```

## Expected Artifacts
- Verification report (raw): `docs/VERIFICATION_S7_DEEP_20260127_4.md`
