# TODO - Phase 3 Tenant Import Env-File Precheck CLI Error Redaction
...
- [x] Stop echoing missing env-file paths.
...
- [x] Cover DSN-like missing env-file paths.
...
- [ ] Source the env file in the precheck.
