...
| Leading capability count | 3 (strict regression evidence autopack, cross-domain impact + release readiness summary APIs, strategy-based validation rulesets + diagnostics for manufacturing + baselines + ECO apply + ruleset directory) |
