...
- 在已完成的 unified proof surface + acknowledgement / waiver trail 之上，
  补 decision expiry / renewal governance
- conversion rule / external conversion routing evidence
- proof-consumer adoption evidence，证明 UI/support/handoff 真的消费这条
...
4. 在 unified proof surface 与 decision trail 完成后，优先补 decision
   expiry / renewal governance，而不是继续散开加新 surface。
