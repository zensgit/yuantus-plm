...
- proof bundle automation tied to regression scenarios
...
3. 再开一个 bounded increment，优先做 `cad_bom mismatch recovery + proof bundle`。
4. 要求每个增量继续同时满足 contract test、runbook、verification evidence。
