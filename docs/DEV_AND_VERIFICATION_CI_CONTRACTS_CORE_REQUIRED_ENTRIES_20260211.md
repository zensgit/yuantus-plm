# CI Contracts: Core Required Entries (2026-02-11)

## Goal

Prevent accidental removal of essential delivery anchors from
`docs/DELIVERY_DOC_INDEX.md` `## Core`.

## Changes

- Added contract test:
  - `src/yuantus/meta_engine/tests/test_delivery_doc_index_core_required_entries_contracts.py`
- Required core anchors:
  - exact paths:
    - `CHANGELOG.md`
    - `docs/VERIFICATION_RESULTS.md`
  - required categories (pattern-based):
    - `docs/RELEASE_NOTES_*.md`
    - `docs/DELIVERY_CHECKLIST_*.md`
    - `docs/DELIVERY_SUMMARY_*.md`
    - `docs/DELIVERY_PACKAGE_MANIFEST_*.txt`
