...
@cutted_parts_router.get("/alerts/overview")
def alerts_overview(
    db: Session = Depends(get_db),
    user: CurrentUser = Depends(get_current_user),
):
...
@cutted_parts_router.get("/outliers/summary")
...
@cutted_parts_router.get("/plans/{plan_id}/alerts")
def plan_alerts(
    plan_id: str,
    db: Session = Depends(get_db),
    user: CurrentUser = Depends(get_current_user),
...
@cutted_parts_router.get("/export/outliers")
def export_outliers(
    db: Session = Depends(get_db),
    user: CurrentUser = Depends(get_current_user),
):
...
@cutted_parts_router.get("/saturation/overview")
...
@cutted_parts_router.get("/bottlenecks/summary")
...
@cutted_parts_router.get("/plans/{plan_id}/bottlenecks")
...
@cutted_parts_router.get("/export/bottlenecks")
