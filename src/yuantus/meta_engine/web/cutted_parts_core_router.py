"""Cutted-parts core plan and material endpoints."""
...
cutted_parts_core_router = APIRouter(prefix="/cutted-parts", tags=["Cutted Parts"])
...
@cutted_parts_core_router.post("/plans")
def create_plan(
...
@cutted_parts_core_router.get("/plans")
def list_plans(
...
@cutted_parts_core_router.get("/plans/{plan_id}")
def get_plan(
    plan_id: str,
    db: Session = Depends(get_db),
    user: CurrentUser = Depends(get_current_user),
...
@cutted_parts_core_router.get("/plans/{plan_id}/summary")
...
@cutted_parts_core_router.get("/plans/{plan_id}/cuts")
def list_cuts(
    plan_id: str,
    db: Session = Depends(get_db),
    user: CurrentUser = Depends(get_current_user),
...
@cutted_parts_core_router.get("/materials")
def list_materials(
