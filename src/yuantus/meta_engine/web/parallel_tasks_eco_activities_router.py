...
parallel_tasks_eco_activities_router = APIRouter(tags=["ParallelTasks"])
...
@parallel_tasks_eco_activities_router.post("/eco-activities")
...
@parallel_tasks_eco_activities_router.get("/eco-activities/{eco_id}")
...
@parallel_tasks_eco_activities_router.post(
    "/eco-activities/activity/{activity_id}/transition"
)
...
@parallel_tasks_eco_activities_router.get(
    "/eco-activities/activity/{activity_id}/transition-check"
)
...
@parallel_tasks_eco_activities_router.post(
    "/eco-activities/{eco_id}/transition-check/bulk"
)
...
@parallel_tasks_eco_activities_router.post("/eco-activities/{eco_id}/transition/bulk")
...
@parallel_tasks_eco_activities_router.get("/eco-activities/{eco_id}/blockers")
...
@parallel_tasks_eco_activities_router.get("/eco-activities/{eco_id}/events")
...
@parallel_tasks_eco_activities_router.get("/eco-activities/{eco_id}/sla")
...
@parallel_tasks_eco_activities_router.get("/eco-activities/{eco_id}/sla/alerts")
...
@parallel_tasks_eco_activities_router.get("/eco-activities/{eco_id}/sla/alerts/export")
