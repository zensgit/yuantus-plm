...
#   (GET /api/v1/versions/items/{item_id}/versions) -- unconditional ItemVersion
#   LIST contract (B1 lifecycle_status/is_superseded made visible; auth = the
#   router's optional dep, same as the sibling /history route).
