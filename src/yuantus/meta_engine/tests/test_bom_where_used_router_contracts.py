...
def test_bom_where_used_router_is_registered_before_legacy() -> None:
    ...
    assert compare_pos < tree_pos < children_pos < obsolete_rollup_pos < where_used_pos < legacy_pos, (
        ...
        f"-> bom_router; got compare={compare_pos}, tree={tree_pos}, "
        f"children={children_pos}, obsolete_rollup={obsolete_rollup_pos}, "
        f"where_used={where_used_pos}, legacy={legacy_pos}."
    )
