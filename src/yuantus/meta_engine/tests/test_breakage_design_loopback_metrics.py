...
def test_prometheus_surface_exposes_three_gauges_no_new_route():
    ...
    # current app-level route-count contract (707 after the 1 CAD-PDM Superseded
    # read-surface route; 706 after the 1 PLM-COLLAB-P3-D1 embed-token mint route;
    # 705 after the 1 WP1.2 stale-drawings route).
