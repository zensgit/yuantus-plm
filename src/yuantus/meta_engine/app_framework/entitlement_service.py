...
FEATURE_APP_NAMES: Mapping[str, FrozenSet[str]] = {
    ...
    # PLM-COLLAB Phase-7: BOM multi-table WRITE-back is its OWN write SKU (governed write
    # endpoint, design-lock #901) -- separate from the bom_multitable READ key above.
