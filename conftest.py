...
_ALLOWLIST_NO_DB = {
    ...
    "src/yuantus/meta_engine/tests/test_lifecycle_transition_attempts.py",
    "src/yuantus/meta_engine/tests/test_lifecycle_transition_history.py",
    "src/yuantus/meta_engine/tests/test_lifecycle_transition_history_router.py",
    ...
    "src/yuantus/meta_engine/tests/test_release_readiness_item_release.py",
    ...
    "src/yuantus/meta_engine/tests/test_plm_erp_publication_router.py",
    "src/yuantus/meta_engine/tests/test_erp_publication_outbox_service.py",
    ...
    "src/yuantus/meta_engine/tests/test_ecm_publication_worker_cli.py",
    ...
    "src/yuantus/meta_engine/tests/test_consumption_mes_async_wiring.py",
    ...
    "src/yuantus/meta_engine/tests/test_find_effective_version.py",
    ...
    "src/yuantus/meta_engine/tests/test_method_sandbox.py",
}
