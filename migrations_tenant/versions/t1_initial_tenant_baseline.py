...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_meta_bom_writeback_audit_org_id'), 'meta_bom_writeback_audit', ['org_id'], unique=False)
    ...
    op.create_index(op.f('ix_meta_bom_writeback_audit_user_id'), 'meta_bom_writeback_audit', ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_meta_bom_writeback_audit_user_id'), table_name='meta_bom_writeback_audit')
    ...
    op.drop_index(op.f('ix_meta_bom_writeback_audit_org_id'), table_name='meta_bom_writeback_audit')
